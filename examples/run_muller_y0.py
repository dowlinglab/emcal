#!/usr/bin/env python3
"""Example: Muller y0 (CS3), signac-free.

Paper case study "Muller y0" (Carlozo, Wang & Dowling, Ind. Eng. Chem. Res. 2025, Table 2).
...
Run (from this examples/ directory):  python run_muller_y0.py
"""
from common import run_case_study

if __name__ == "__main__":
    run_case_study(cs_num=3, method_val=7, iters=10, runs=1)
